...
#ifndef DECODE_MYPROTOCOL
#define DECODE_MYPROTOCOL          _IR_ENABLE_DEFAULT_
#endif  // DECODE_MYPROTOCOL
#ifndef SEND_MYPROTOCOL
#define SEND_MYPROTOCOL            _IR_ENABLE_DEFAULT_
...
#define SEND_AIRTON         _IR_ENABLE_DEFAULT_
     ...
     DECODE_VOLTAS || /*DECODE_MIRAGE ||*/ DECODE_MYPROTOCOL || DECODE_HAIER_AC176 || \
...
const uint16_t kMyProtocolStateLength = 15;
const uint16_t kMyProtocolBits = kMyProtocolStateLength * 8;
const uint16_t kMyProtocolMinRepeat = kNoRepeat;
